...
public class MyLinkedList<E> implements List<E> {
    ...
    private void checkElementPositionIndex(int index) {
        if (!isElementIndex(index))
            throw new IndexOutOfBoundsException("Index: " + index + ". Size of the MyLinkedList: " + size + ".");
    }
...
//        System.out.println(list1.get(1));
        list1.clear();
        System.out.println("Print the size of the MyLinkedList after deleting all elements - " + list1.size());
    }
}
